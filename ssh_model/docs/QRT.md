...
hence periodic boundary conditions), and a classical driving field $A(t) = A_0 \sin(2\pi \Omega t)$. Here we describe some of the relevant theory, particularly that relating to the use of the Quantum Regression Theorem. We always work in the eigenbasis of the unperturbed Hamiltonian.
