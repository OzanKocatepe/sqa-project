...
class Plotting:
    ...
    def PlotDoubleTimeCurrent(self) -> None:
        ...
        curr = self.__ensemble.total_model_data
        axes = self.__ensemble.axes
        subscripts = ['x', 'y']
    ...
    def PlotTotalCurrent(self) -> None:
        ...
        axes = self.__ensemble.axes
        current = self.__ensemble.total_model_data.total_current
    ...
    def PlotIntegratedSecondOrderCurrent(self) -> None:
        ...
        axes = self.__ensemble.axes
        current = self.__ensemble.total_model_data.t_averaged_second_order_current
    ...
    def PlotTotalCurrentFFT(self, linearScale: bool=False) -> None:
        ...
        axes = self.__ensemble.axes
        current = self.__ensemble.total_model_data
