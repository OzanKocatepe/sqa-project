...
# g2(0) FULL SIZE
plt.plot(np.arange(1, maxN + 1), one_ensemble_current.second_order_correlation_function[0], marker = 'x', color='red', linestyle='-')
plt.plot(np.arange(1, maxN + 1), one_ensemble_current.second_order_correlation_function[1], marker = 'x', color='red', linestyle='--')
plt.plot(np.arange(1, maxN + 1), three_ensemble_current.second_order_correlation_function[0], marker = 'x', color='blue', linestyle='-')
plt.plot(np.arange(1, maxN + 1), three_ensemble_current.second_order_correlation_function[1], marker = 'x', color='blue', linestyle='--')
