...
axes, one_current = np.load(DATA_DIR / "A=0.2, D=1.0, k=21, t=11.npy", allow_pickle = True)
_, three_current = np.load(DATA_DIR / "A=0.2, D=3.0, k=21, t=11.npy", allow_pickle = True)
maxN = 50
